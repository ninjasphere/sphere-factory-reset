...
PRIVATE_PKG="ninjasphere/go-ninja ninjasphere/sphere-setup-assistant ninjasphere/sphere-go-led-controller ninjasphere/driver-go-blecombined ninjasphere/sphere-factory-test ninjablocks/linux-rootfs-scripts"
